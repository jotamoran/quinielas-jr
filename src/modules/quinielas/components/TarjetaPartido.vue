...
<template>
  <article class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:p-5">
    ...
    <div v-else class="grid grid-cols-3 gap-2" role="radiogroup" :aria-label="`Pronóstico de ${partido.equipo_local} contra ${partido.equipo_visitante}`">
