export default [
  ...
  { path: '/admin/administrar-jornadas', name: 'admin-administrar-jornadas', component: () => import('./views/AdministrarJornadas.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
